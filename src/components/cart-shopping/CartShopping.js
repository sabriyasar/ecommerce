    ...
    return (
        <>
            <div onClick={closeCartOnBg} dataset='box-cart' style={{backgroundColor: 'rgba(107, 114, 128, 0.5)'}} className='fixed left-0 top-0 right-0 bottom-0 z-[1] flex flex-col items-center justify-center shadow-2xl'>
                <div className='bg-white mx-4 rounded-lg w-[95%] sm:w-[500px] sm:mx-0 md:w-[700px] lg:w-[430px]'>
                    <div className='flex justify-between items-center p-3 border-b'>
                        <span className='text-lg sm:text-xl'>Cart</span>
                        ...
                        cart.length === 0
                            ...
                            :   <>
                                ...
                                <div className='flex justify-center pr-0 py-3 sm:py-4 sm:pr-6 sm:justify-end'>
                                    <div className='w-fit py-3 px-2 rounded-xl border flex flex-col justify-between items-center sm:flex-row sm:py-5 sm:px-24'>
                                        <div className='mr-0 sm:mr-4'>
                                            <span className='mr-2 text-base sm:text-xl'>Total Price:</span>
                                            <span className='text-[#2a59fe] sm:text-xl'>{totalPrice()}₺</span>
                                            <br />
                                            <button className='text-sm sm:text-lg bg-[#2a59fe] text-white px-[60px] py-[5px] rounded transition mt-1 sm:mt-0'>Checkout</button>
                                        </div>
                                    </div>
                                </div>
                            </>
